...
状态：两端自动补采已启用，部分生产场景已验证；Nekro 小窗口断线 canary 通过，Lily
真实午夜断档已完成一轮补采并保留缺口，剩余场景待补齐验收（2026-09-12 复核）。
不是“尚未真实测试”，也不承诺全量历史完整恢复。
...
- 尚待补齐的是可对照的私聊断线样本、NapCat 自身离线等剩余生产场景与阶段签署；
